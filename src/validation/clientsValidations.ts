...
export const clientRecordSchema = yup.object({
  doctor_id: yup.mixed().required("لطفا پزشک را انتخاب کنید"),
  supervisor_id: yup.mixed().required("لطفا سوپروایزر را انتخاب کنید"),
  admin_id: yup.mixed().required("لطفا پذیرش کننده را انتخاب کنید"),
