...
import { workshopSchema } from "@/validation";
...
export default function EditWorkshopForm({
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(
    workshop.image_url || workshop.img_path || null
  );
  ...
  useEffect(() => {
    if (watchImage && watchImage.length > 0) {
      ...
      setImagePreview(workshop.image_url || workshop.img_path || null);
    }
  }, [watchImage, workshop.image_url, workshop.img_path]);
